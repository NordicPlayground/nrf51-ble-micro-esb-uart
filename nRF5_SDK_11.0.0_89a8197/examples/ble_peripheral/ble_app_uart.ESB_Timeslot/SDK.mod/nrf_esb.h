...
#elif defined (NRF52)
#define ESB_EVT_IRQ        SWI3_EGU3_IRQn                           /**< ESB Event IRQ number when running on a nRF52 device. */
#define ESB_EVT_IRQHandler SWI3_EGU3_IRQHandler                     /**< The handler for ESB_EVT_IRQ when running on a nRF52 device. */
#endif /* NRF51 */
